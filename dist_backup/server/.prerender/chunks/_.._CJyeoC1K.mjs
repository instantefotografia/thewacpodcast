...
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as addAttribute, d as Fragment, u as unescapeHTML, c as renderSlot } from './prerender_BEPFSR4y.mjs';
...
</a>`} </div>`} </div> <div class="max-w-4xl mx-auto"> ${summaryParagraphs.length > 0 && renderTemplate`${renderComponent($$result3, "Fragment", Fragment, {}, { "default": async ($$result4) => renderTemplate` ${renderComponent($$result4, "Text", $$Text, { "tag": "h2", "variant": "textXS", "class": "mt-24 text-base-900 uppercase lg:mt-40" }, { "default": async ($$result5) => renderTemplate`
summary
` })} ${renderComponent($$result4, "Wrapper", $$Wrapper, { "variant": "prose", "class": "mt-2 max-w-none" }, { "default": async ($$result5) => renderTemplate`${summaryParagraphs.map((para) => renderTemplate`<p>${para}</p>`)}` })} ` })}`} ${keyQuotesList.length > 0 && renderTemplate`${renderComponent($$result3, "Fragment", Fragment, {}, { "default": async ($$result4) => renderTemplate` ${renderComponent($$result4, "Text", $$Text, { "tag": "h2", "variant": "textXS", "class": "mt-12 text-base-900 uppercase lg:mt-20" }, { "default": async ($$result5) => renderTemplate`
key quotes
` })} <div class="mt-4 space-y-6"> ${keyQuotesList.map((quote) => renderTemplate`<blockquote class="border-l-2 border-base-900 pl-5 italic text-base-600 text-sm leading-relaxed"> ${quote} </blockquote>`)} </div> ` })}`}  ${transcriptHtml ? renderTemplate`${renderComponent($$result3, "Fragment", Fragment, {}, { "default": async ($$result4) => renderTemplate` <details class="mt-12 lg:mt-20 group"> <summary class="cursor-pointer list-none flex items-center justify-between"> ${renderComponent($$result4, "Text", $$Text, { "tag": "span", "variant": "textXS", "class": "text-base-900 uppercase" }, { "default": async ($$result5) => renderTemplate`
transcript
` })} <span class="text-base-400 text-xs group-open:hidden">+ show</span> <span class="text-base-400 text-xs hidden group-open:inline">− hide</span> </summary> ${renderComponent($$result4, "Wrapper", $$Wrapper, { "variant": "prose", "class": "mt-4 max-w-none" }, { "default": async ($$result5) => renderTemplate`${unescapeHTML(transcriptHtml)}` })} </details> ` })}` : renderTemplate`${renderComponent($$result3, "Fragment", Fragment, {}, { "default": async ($$result4) => renderTemplate` ${renderComponent($$result4, "Text", $$Text, { "tag": "h2", "variant": "textXS", "class": "mt-24 text-base-900 uppercase lg:mt-40" }, { "default": async ($$result5) => renderTemplate`
overview
...
}, "/sessions/eager-modest-galileo/mnt/WAC - Website/src/layouts/EpisodeLayout.astro", void 0);
...
}, "/sessions/eager-modest-galileo/mnt/WAC - Website/src/pages/podcast/interviews/[...slug].astro", void 0);

const $$file = "/sessions/eager-modest-galileo/mnt/WAC - Website/src/pages/podcast/interviews/[...slug].astro";
